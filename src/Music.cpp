...
GameMusic::GameMusic()
{
	...
	std::array<std::string, _count_game_music>nameFile{ "sound/PacMan_Tem.ogg", "sound/Staring_fun.ogg", "sound/f_1.ogg",  "sound/f_2.ogg", "sound/f_3.ogg", "sound/f_4.ogg", "sound/f_4.ogg", "sound/f_6.ogg", "sound/f_7.ogg" };
